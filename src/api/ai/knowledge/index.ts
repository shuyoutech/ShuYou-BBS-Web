...
import type {
  KnowledgeDocQuery,
  KnowledgeDocSaveBo,
  KnowledgeDocSliceQuery, KnowledgeDocSliceSaveBo, KnowledgeDocSliceUpdateBo,
  KnowledgeDocSliceVo,
  KnowledgeDocUpdateBo,
  KnowledgeDocVo,
  KnowledgeQuery,
  KnowledgeSaveBo,
  KnowledgeUpdateBo,
 ...
 * 知识库管理-新增
 */
export function knowledgeSaveApi(data: KnowledgeSaveBo): Promise<AxiosResponse<string>> {
  return api({
    url: '/knowledge/save',
    method: 'post',
    data: data
 ...
 * 知识库管理-修改
 */
export function knowledgeUpdateApi(data: KnowledgeUpdateBo): Promise<AxiosResponse<boolean>> {
  return api({
 ...
 * 知识库文档管理-新增
 */
export function knowledgeDocSaveApi(data: KnowledgeDocSaveBo): Promise<AxiosResponse<string>> {
  return api({
 ...
 * 知识库文档管理-修改
 */
export function knowledgeDocUpdateApi(data: KnowledgeDocUpdateBo): Promise<AxiosResponse<boolean>> {
  return api({
 ...
 * 知识库文档切片管理-新增
 */
export function knowledgeDocSliceSaveApi(data: KnowledgeDocSliceSaveBo): Promise<AxiosResponse<string>> {
  return api({
 ...
 * 知识库文档切片管理-修改
 */
export function knowledgeDocSliceUpdateApi(data: KnowledgeDocSliceUpdateBo): Promise<AxiosResponse<boolean>> {
  return api({
