...
import type {MenuQuery, MenuSaveBo, MenuUpdateBo, MenuVo} from "@/api/system/menu/types.ts";
 ...
 * 菜单管理-新增
 */
export function menuSaveApi(data: MenuSaveBo): Promise<AxiosResponse<number>> {
    return api({
        url: '/menu/save',
        method: 'post',
        data: data
 ...
 * 菜单管理-修改
 */
export function menuUpdateApi(data: MenuUpdateBo): Promise<AxiosResponse<boolean>> {
    return api({
        url: '/menu/update',
        method: 'post',
        data: data
 ...
 * 菜单管理-删除
 */
export function menuDeleteApi(data: string[]): Promise<AxiosResponse<boolean>> {
    return api({
        url: '/menu/delete',
        method: 'post',
        data: data
