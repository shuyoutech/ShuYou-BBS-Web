...
import type {VectorQuery, VectorSaveBo, VectorUpdateBo, VectorVo} from "@/api/ai/vector/types.ts";
 ...
 * 向量数据库管理-新增
 */
export function vectorSaveApi(data: VectorSaveBo): Promise<AxiosResponse<string>> {
  return api({
    url: '/vector/save',
    method: 'post',
    data: data
 ...
 * 向量数据库管理-修改
 */
export function vectorUpdateApi(data: VectorUpdateBo): Promise<AxiosResponse<boolean>> {
  return api({
    url: '/vector/update',
    method: 'post',
    data: data
