...
import type {ProviderQuery, ProviderSaveBo, ProviderUpdateBo, ProviderVo} from "@/api/ai/provider/types.ts";
 ...
 * 供应商管理-新增
 */
export function providerSaveApi(data: ProviderSaveBo): Promise<AxiosResponse<string>> {
  return api({
    url: '/provider/save',
    method: 'post',
    data: data
 ...
 * 供应商管理-修改
 */
export function configUpdateApi(data: ProviderUpdateBo): Promise<AxiosResponse<boolean>> {
  return api({
    url: '/provider/update',
    method: 'post',
    data: data
