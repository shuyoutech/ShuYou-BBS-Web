...
import type {
  OrgQuery, OrgSaveBo, OrgUpdateBo, OrgVo,
 ...
 * 机构管理-新增
 */
export function orgSaveApi(data: OrgSaveBo): Promise<AxiosResponse<number>> {
  return api({
    url: '/org/save',
    method: 'post',
    data: data
 ...
 * 机构管理-修改
 */
export function orgUpdateApi(data: OrgUpdateBo): Promise<AxiosResponse<boolean>> {
  return api({
    url: '/org/update',
    method: 'post',
    data: data
 ...
 * 机构管理-删除
 */
export function orgDeleteApi(data: string[]): Promise<AxiosResponse<boolean>> {
  return api({
    url: '/org/delete',
    method: 'post',
    data: data
