...
import type {AppChatCompletionsBo, AppChatTestBo, AppQuery, AppSaveBo, AppUpdateBo, AppVo} from "@/api/ai/app/types.ts";
 ...
 * 应用管理-新增
 */
export function appSaveApi(data: AppSaveBo): Promise<AxiosResponse<string>> {
  return api({
    url: '/app/save',
    method: 'post',
    data: data
 ...
 * 应用管理-修改
 */
export function appUpdateApi(data: AppUpdateBo): Promise<AxiosResponse<boolean>> {
  return api({
    url: '/app/update',
    method: 'post',
    data: data
