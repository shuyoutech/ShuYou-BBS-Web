...
import type {ConfigQuery, ConfigSaveBo, ConfigUpdateBo, ConfigVo} from "@/api/system/config/types.ts";
 ...
 * 参数配置管理-新增
 */
export function configSaveApi(data: ConfigSaveBo): Promise<AxiosResponse<string>> {
  return api({
    url: '/config/save',
    method: 'post',
    data: data
 ...
 * 参数配置管理-修改
 */
export function configUpdateApi(data: ConfigUpdateBo): Promise<AxiosResponse<boolean>> {
  return api({
    url: '/config/update',
    method: 'post',
    data: data
